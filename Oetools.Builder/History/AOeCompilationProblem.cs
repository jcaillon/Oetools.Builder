...
namespace Oetools.Builder.History {
    ...
    public abstract class AOeCompilationProblem {
        ...
        internal static AOeCompilationProblem New(AUoeCompilationProblem  problem) {
            ...
            switch (problem) {
                ...
                case UoeCompilationWarning _:
                    ...
                    break;
                default:
                    throw new ArgumentOutOfRangeException(nameof(AUoeCompilationProblem), problem, "no matching type");
            }
