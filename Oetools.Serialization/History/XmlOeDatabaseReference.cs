...
namespace Oetools.Utilities.Openedge {
    ...
    /// </summary>
    public class XmlOeDatabaseReference {
        public virtual string QualifiedName { get; set; }
    }
    
    public class XmlOeDatabaseReferenceSequence : XmlOeDatabaseReference {
    }
    
    public class XmlOeDatabaseReferenceTable : XmlOeDatabaseReference {
